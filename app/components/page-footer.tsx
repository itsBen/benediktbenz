...
export default function PageFooter() {
  return (
    <footer className="site-footer fixed inset-x-0 bottom-0 z-30 px-6 py-4 md:px-12">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-2 text-sm md:flex-row md:items-center md:justify-between">
        <p className="text-[var(--color-text-muted)]">
          Copyright {new Date().getFullYear()} Benedikt Benz. All
          rights reserved.
        </p>
